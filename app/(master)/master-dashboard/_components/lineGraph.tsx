    ...
    return (
      <div className="flex flex-col w-full h-full gap-3 items-center justify-center">
        ...
        <div className="flex gap-3 w-full max-h-max">
          <button
            className="bg-yellow-500 text-[0.35rem] sm:text-xs text-white px-1 sm:px-2 py-1 rounded-md sm:rounded-lg"
        ...
        <div className="flex flex-row gap-3 sm:gap-5 max-sm:items-start">
          <div className="flex flex-row gap-2 sm:items-center justify-center">
            <label htmlFor="start" className="font-bold text-[0.5rem] sm:text-sm">Mulai : </label>
            <input 
              id="start"
              type="date" 
          ...
          <div className="flex flex-row gap-2 sm:items-center justify-center">
            <label htmlFor="end" className="font-bold text-[0.5rem] sm:text-sm">Akhir : </label>
            <input 
              id="end"
              type="date" 
